...
import type { PluginOptions } from "./WebsmithLitePlugin";
...
export const initializeInstance = (loaderInstance: webpack.LoaderContext<PluginOptions>, options: CompilerOptions): LiteCompiler => {
